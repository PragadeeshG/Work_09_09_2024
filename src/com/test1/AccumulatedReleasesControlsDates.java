...
public class AccumulatedReleasesControlsDates {
	...
	private String accumulatedReleaseDate;
	private String uvtDate;
	private String creationDate;
	private String modifiedDate;
	private String entityState;

	public AccumulatedReleasesControlsDates() {

	}

	public AccumulatedReleasesControlsDates(Integer accumulatedReleaseIndicator, String azureStoryCreationDate,
			...
			String accumulatedReleaseDate, String uvtDate, String creationDate, String modifiedDate,
			String entityState) {
		super();
		...
		this.accumulatedReleaseDate = accumulatedReleaseDate;
	...
	public String getAccumulatedReleaseDate() {
		return accumulatedReleaseDate;
	}

	public void setAccumulatedReleaseDate(String accumulatedReleaseDate) {
		this.accumulatedReleaseDate = accumulatedReleaseDate;
	}
